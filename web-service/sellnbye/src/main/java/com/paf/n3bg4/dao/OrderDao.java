...
import com.paf.n3bg4.models.Order;
import com.paf.n3bg4.models.ProductUpdateModel;
...
//	public boolean updateOrdert(ProductUpdateModel pro) {
//		boolean isSuccess;
//		try {
//
//			String sql;
...
//	}
	...
	public boolean deleteOrder(String product) {
		...
		try {
			...
			System.out.println("[Error][OrderDao][deleteOrdert] - " + ex.toString());
			isSuccess = false;
		}
		return isSuccess;
	} 
